...
public class CommunityServiceImpl implements BoardService {
    ...
    public void post(BoardDto boardDto, MultipartFile[] uploadFiles) {
        ...
        communityDao.write(boardDto, boardFileDtoList);
    }
    ...
    public List<BoardDto> getBoardList(Map<String, String> searchMap, Criteria cri) {
        ...
        return communityDao.getBoardList(paramMap);
    }
    ...
    public int getBoardTotalCnt(Map<String, String> searchMap) {
        return communityDao.getBoardTotalCnt(searchMap);
    }

    @Override
    public List<BoardFileDto> getBoardFileList(int id) {
        return communityDao.getFreeBoardFileList(id);
    }
