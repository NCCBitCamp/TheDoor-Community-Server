        ...
        <div class="container mt-3">
            <form id="modify-form" action="/news/newsModify.do" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" class="form-control" id="writer" name="value="${news.nickname}" value="관리자" readonly>
                </div>
                <div class="form-group mt-3">
                ...
                <c:if test="${loginMember ne null and loginMember.user_id eq news.writer_id}">
                    <div class="btn-container mt-3 mb-5">
                        <button type="submit" id="btn-update" class="btn btn-outline-secondary">수정</button>
                        <button type="button" id="btn-delete" class="btn btn-outline-secondary ml-2" onclick="location.href='/news/delete.do?id=${news.id}'">삭제</button>
                    </div>
                </c:if>
            </form>
        </div>
