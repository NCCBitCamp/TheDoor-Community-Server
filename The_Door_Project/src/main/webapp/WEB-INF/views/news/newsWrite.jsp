...
<html>
<head>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/news/newsWrite.css">
...
<body>
    ...
    <main>
        ...
        <div class="container mt-3">
            <form id="writeForm" action="/news/newsWrite.do" method="post" enctype="multipart/form-data">
